...
(function ($) {
  ...
  $.fn.dropCatchGame = function (options) {
    ...
    var settings = $.extend({
      ...
      dropSVG: ['img/food-1.svg', 'img/food-2.svg', 'img/food-3.svg'],// SVG image of good drop item
      ...
      catchSVG: 'img/pan3.svg',// SVG image of catch item
      catchMovingSVG: 'img/pan3.svg',// SVG image of catch item
      catchSVGWidth: 108,// Width of SVG image of catch item
      catchSVGHeight: 94,// Height of SVG image of catch item
